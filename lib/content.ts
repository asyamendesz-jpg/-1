...
export const portfolio = [
  ...
  },
  {
    ...
    title: "Выразительный взгляд",
    caption: "Работа салона: объёмное наращивание ресниц.",
    before: "/images/ba-lash-before.jpg",
    after: "/images/salon/lashes-volume-closeup.jpg",
    isPlaceholder: false,
  },
  {
    id: "p4",
  ...
  },
  {
    ...
    category: "lashes" as DirectionId,
    title: "Объём ресниц",
    caption: "Работа салона: макросъёмка наращивания.",
    before: "/images/ba-lash-before.jpg",
    after: "/images/salon/lashes-volume-macro.png",
    isPlaceholder: false,
  },
  {
    id: "p7",
