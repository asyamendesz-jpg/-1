...
export const categories: ServiceCategory[] = [
  {
    ...
    imageAlt: "[ФОТО РАБОТЫ] Гладкие ухоженные волосы — заменить на реальную работу салона",
    href: "/uslugi/volosy",
  ...
  },
  {
    ...
    image: "/images/cat-extensions.jpg",
    imageAlt: "[ФОТО РАБОТЫ] Наращивание волос — заменить на реальную работу салона",
  ...
  },
  {
    ...
    imageAlt: "[ФОТО РАБОТЫ] Ресницы — заменить на реальную работу салона",
  ...
  },
  {
    ...
    image: "/images/cat-brows.jpg",
    imageAlt: "[ФОТО РАБОТЫ] Оформление бровей — заменить на реальную работу салона",
    href: "/uslugi/brovi",
...
export const portfolio = [
  {
    ...
    caption: "[ФОТО РАБОТЫ] Кератин / нанопластика — заменить на реальное до/после салона",
  ...
  },
  {
    ...
    title: "Длина и объём",
    caption: "[ФОТО РАБОТЫ] Наращивание — заменить на реальное до/после салона",
    before: "/images/ba-ext-before.jpg",
    after: "/images/ba-ext-after.jpg",
    isPlaceholder: true,
  },
  {
    id: "p3",
    ...
    title: "Выразительный взгляд",
    caption: "[ФОТО РАБОТЫ] Ресницы — заменить на реальное до/после салона",
  ...
  },
  {
    ...
    caption: "[ФОТО РАБОТЫ] Брови — заменить на реальное до/после салона",
...
export const masters = [
  {
    ...
    works: [
      { src: "/images/ba-hair-after.jpg", alt: "[ФОТО РАБОТЫ МАСТЕРА]" },
      { src: "/images/ba-ext-after.jpg", alt: "[ФОТО РАБОТЫ МАСТЕРА]" },
    ],
    isPlaceholder: true,
  },
  {
    ...
    photo: "/images/cat-lashes.jpg",
    photoAlt: "[ФОТО МАСТЕРА] Заменить на профессиональный портрет",
    directions: ["lashes"] as DirectionId[],
    works: [
      { src: "/images/ba-lash-after.jpg", alt: "[ФОТО РАБОТЫ МАСТЕРА]" },
      { src: "/images/cat-lashes.jpg", alt: "[ФОТО РАБОТЫ МАСТЕРА]" },
    ],
    isPlaceholder: true,
  },
  {
    ...
    quote: "[ПРИНЦИП РАБОТЫ МАСТЕРА]",
    photo: "/images/cat-brows.jpg",
    photoAlt: "[ФОТО МАСТЕРА] Заменить на профессиональный портрет",
    directions: ["brows"] as DirectionId[],
    works: [
      { src: "/images/ba-brow-after.jpg", alt: "[ФОТО РАБОТЫ МАСТЕРА]" },
      { src: "/images/cat-brows.jpg", alt: "[ФОТО РАБОТЫ МАСТЕРА]" },
    ],
    isPlaceholder: true,
  },
];
...
export const testimonials = [
  {
    ...
    name: "[ИМЯ КЛИЕНТА]",
    procedure: "[ПРОЦЕДУРА]",
    photo: "/images/ba-hair-after.jpg",
    isPlaceholder: true,
  ...
  },
  {
    ...
    name: "[ИМЯ КЛИЕНТА]",
    procedure: "[ПРОЦЕДУРА]",
    photo: "/images/ba-lash-after.jpg",
    isPlaceholder: true,
    problem: "[ИСХОДНАЯ ПРОБЛЕМА]",
    result: "[РЕЗУЛЬТАТ]",
    impression: "[ВПЕЧАТЛЕНИЕ КЛИЕНТА]",
